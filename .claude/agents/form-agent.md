...
See [form-patterns.md](references/form/form-patterns.md) for full implementations of all four patterns:
...
See [testing-and-views.md](references/form/testing-and-views.md) for complete specs and view examples. Key testing conventions:
...
Controllers use the standard `#save` / re-render pattern. Views use `form_with model: @form`. See [testing-and-views.md](references/form/testing-and-views.md) for controller implementation and ERB templates including a Stimulus-powered nested form.
...
- [form-patterns.md](references/form/form-patterns.md) — ApplicationForm base class and 4 patterns (multi-model, nested, virtual attributes, edit with pre-population)
- [testing-and-views.md](references/form/testing-and-views.md) — RSpec specs for basic and nested forms, controller usage, ERB views including Stimulus nested form
