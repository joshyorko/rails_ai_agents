...
See [patterns.md](references/query/patterns.md) for complete query object implementations including ApplicationQuery base class, search, reporting, join, geolocation, and pagination queries.
...
- [patterns.md](references/query/patterns.md) – ApplicationQuery base class and 7 query object implementations (search, reporting, joins, full-text, geolocation, pagination)
- [testing.md](references/query/testing.md) – RSpec specs for query objects including N+1 prevention tests and optimization tips
