...
See [model-patterns.md](references/model/model-patterns.md) for the full structure template and 8 common patterns (enums, polymorphic associations, custom validations, scopes, callbacks, delegations, JSON attributes).

## RSpec Model Tests

See [testing-and-factories.md](references/model/testing-and-factories.md) for full specs and factory examples. Key patterns:
