...
Four patterns cover the most common scenarios. See [patterns.md](references/service/patterns.md) for full implementations:
...
See [testing.md](references/service/testing.md) for full specs covering:
