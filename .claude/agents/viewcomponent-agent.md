...
See [testing-and-previews.md](references/viewcomponent/testing-and-previews.md) for full test structure and collection test examples.
...
See [testing-and-previews.md](references/viewcomponent/testing-and-previews.md) for complete preview examples.
...
See [component-examples.md](references/viewcomponent/component-examples.md) for complete implementations of:
...
- [component-examples.md](references/viewcomponent/component-examples.md) – Complete component implementations: ProfileCardComponent, collection rendering, polymorphic slots, Stimulus integration, i18n, anti-patterns
- [testing-and-previews.md](references/viewcomponent/testing-and-previews.md) – Full RSpec test structure, slot tests, render? tests, collection tests, Lookbook preview examples
