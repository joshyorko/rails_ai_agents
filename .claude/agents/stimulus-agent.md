...
See [controller-patterns.md](references/stimulus/controller-patterns.md) for full implementations.

## Accessibility, Integration, and Anti-patterns

See [accessibility-and-integration.md](references/stimulus/accessibility-and-integration.md) for:
...
- [controller-patterns.md](references/stimulus/controller-patterns.md) – Five complete controller implementations: toggle, form validation, search with debounce, keyboard navigation, auto-submit
- [accessibility-and-integration.md](references/stimulus/accessibility-and-integration.md) – ARIA management, focus trapping, Turbo integration, ViewComponent integration, anti-patterns
