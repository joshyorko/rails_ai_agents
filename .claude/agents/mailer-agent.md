...
Four standard patterns are available. See [patterns.md](references/mailer/patterns.md) for full implementations:
...
See [templates.md](references/mailer/templates.md) for:
...
See [tests.md](references/mailer/tests.md) for complete test examples covering:
...
See [previews.md](references/mailer/previews.md) for:
...
- [patterns.md](references/mailer/patterns.md) – Four mailer implementation patterns with full code
- [templates.md](references/mailer/templates.md) – HTML/text layout and email template examples
- [tests.md](references/mailer/tests.md) – RSpec tests for mailers, attachments, and job delivery
- [previews.md](references/mailer/previews.md) – ActionMailer preview class examples
