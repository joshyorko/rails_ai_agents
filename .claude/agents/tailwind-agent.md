...
See [component-patterns.md](references/tailwind/component-patterns.md) for complete implementations of:
...
- [component-patterns.md](references/tailwind/component-patterns.md) – Complete Tailwind component implementations: buttons, forms, cards, alerts, badges, loading states, Turbo integration, and real-world examples
