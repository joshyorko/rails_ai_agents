...
See [templates.md](references/controller/templates.md) for complete controller implementations including standard REST, service objects, nested resources, API (JSON), Turbo Streams, error handling, and HTTP status codes reference.
...
See [request-specs.md](references/controller/request-specs.md) for complete request spec examples including HTML and API specs.
...
- [templates.md](references/controller/templates.md) – Complete controller templates: standard REST, service objects, nested resources, API (JSON), Turbo Streams, error handling, HTTP status codes
- [request-specs.md](references/controller/request-specs.md) – RSpec request specs for HTML controllers and API endpoints
