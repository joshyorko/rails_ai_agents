...
See [patterns.md](references/presenter/patterns.md) for complete presenter implementations including ApplicationPresenter base class, User, Post, Collection, Order, and Booking presenters, plus view usage examples.
